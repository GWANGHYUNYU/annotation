...
class FileManager(QWidget):
    ...
    def file_folder_analysis(self, sel_path):
        ...
        #     for j in range(0, len(self.species_list)):
        #         if i == self.species_class_index_list[j]:
        #             print('--- 식물종 : ' + self.species_list[j] + ' 영상 개수 : {}'.format(self.species_cnt_list[j]))
        #             print('----- 잎 : {}, 꽃/열매 : {}, 전초 : {}, 여러전초 : {}'.format(self.species_leaf_cnt_list[j],
        #                                                                        self.species_flower_fruit_cnt_list[j],
        #                                                                        self.species_entire_cnt_list[j],
        #                                                                        self.species_multi_entire_cnt_list[j]))
        ...
        #     species_cnt_str = str(self.species_cnt_list[i])
        #     leaf_cnt_str = str(self.species_leaf_cnt_list[i])
        #     flower_fruit_cnt_str = str(self.species_flower_fruit_cnt_list[i])
        #     entire_cnt_str = str(self.species_entire_cnt_list[i])
        #     multi_entire_cnt_str = str(self.species_multi_entire_cnt_list[i])
        #
        #     print(class_str + ' ' + species_str + ' ' + species_cnt_str + ' ' + leaf_cnt_str + ' ' + flower_fruit_cnt_str + ' ' + entire_cnt_str + ' ' + multi_entire_cnt_str)
